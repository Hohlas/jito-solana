...
pub struct TipManager {
    ...
    // Optional alternative tip receiver to divert tips (fake receiver). When present,
    // higher-level logic may switch the on-chain tip receiver between the classic
    // per-epoch PDA and this address.
